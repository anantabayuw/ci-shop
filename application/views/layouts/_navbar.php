<nav class="navbar navbar-expand-md navbar-light fixed-top bg-light">
      <div class="container">
        ...
        <a class="navbar-brand" href="http://localhost/cishop">CI Shop</a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
              <a class="nav-link" href="http://localhost/cishop">Home <span class="sr-only">(current)</span></a>
            </li>
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a href="cart.html" class="nav-link"><i class="fas fa-shopping-cart">0</i></a>
            </li>
            <li class="nav-item">
